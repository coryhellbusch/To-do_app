package net.example.todo.service.impl;

import lombok.AllArgsConstructor;
import net.example.todo.dto.TodoDto;
import net.example.todo.entity.Todo;
import net.example.todo.exception.ResourceNotFoundException;
import net.example.todo.repository.TodoRepository;
...
//        savedTodoDto.setCompleted(savedTodo.isCompleted());
    ...
    public TodoDto completeTodo(Long id) {
        Todo todo = todoRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Toto not found with id " + id));
